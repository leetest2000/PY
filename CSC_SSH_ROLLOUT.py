...
{7}================================================================================================================{0}
{10} - CHG0370364 - Deployment script - This script will deploy configuration in dir /home/lee.wilson/PY/SSH_Rollout/CMDS/*.txt
{7}================================================================================================================{0}
...
confirmed = input('\nAre you SURE you want to deploy CHG0370364? (y/n) \n')
if 'n' in confirmed:
	sys.exit('aborting')
elif 'N' in confirmed:
	sys.exit('aborting')
...
for host in host_targets:
	...
	try:
		...
		dev.cliCmd('end')
		dev.cliCmd('wr')
		out5 = dev.cliCmd('show run | beg line c')
		for line in out5:
			print(line)
		file.write('\n')
		file.close()
